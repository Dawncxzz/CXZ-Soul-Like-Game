...
namespace CXZ
{
    public class PlayerLocomotion : MonoBehaviour
    {
        ...
        public void HandleMovement(float delta)
        {
            ...
            {
                animatorHandler.UpdateAnimatorValue(inputHandler.vertical, inputHandler.horizontal, playerManager.isSpriting);
            }
            else
            {
        ...
        public void HandleRollingAndSprinting(float delta)
        {
            ...
            if (inputHandler.rollFlag)
            {
                ...
                {
                    animatorHandler.PlayerTargetAnimation("Rolling", true, false);
                    moveDirection.y = 0;
                ...
                {
                    animatorHandler.PlayerTargetAnimation("Step_Back", true, false);
        ...
        public void HandleFalling(float delta)
        {
            ...
            if (Physics.Raycast(origin, -Vector3.up, out hit, minimumDistanceNeededToBeginFall, ignoreForGroundCheck))
            {
                ...
                if (playerManager.isInAir)
                {
                    if (inAirTimer > 0.5)
                    {
                        animatorHandler.PlayerTargetAnimation("Land", true, false);
                        inAirTimer = 0;
                    }
                    else
                    {
                        animatorHandler.PlayerTargetAnimation("Empty", false, true);
                        inAirTimer = 0;
                    }
            ...
            else
            {
                ...
                if (playerManager.isInAir == false)
                {
                    ...
                    {
                        animatorHandler.PlayerTargetAnimation("Falling", true, true);
                    }
        ...
        public void HandleJumping()
        {
            ...
            if (inputHandler.jump_Input)
            {
                if (inputHandler.moveAmount > 0)
                {
                    moveDirection = cameraObject.forward * inputHandler.vertical;
                    moveDirection += cameraObject.right * inputHandler.horizontal;
                    animatorHandler.PlayerTargetAnimation("Jump", true, false);
                    moveDirection.y = 0;
